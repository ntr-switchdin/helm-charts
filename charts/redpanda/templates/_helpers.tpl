...
{{- get ((include "redpanda.StorageMinFreeBytes" (dict "a" (list .))) | fromJson) "r" }}
{{- end -}}
...
{{- get ((include "redpanda.CommonMounts" (dict "a" (list .))) | fromJson) "r" | toYaml }}
{{- end -}}

{{/* mounts that are common to most containers */}}
{{- define "default-mounts" -}}
{{- get ((include "redpanda.DefaultMounts" (dict "a" (list .))) | fromJson) "r" | toYaml }}
{{- end -}}

{{/* volumes that are common to all pods */}}
{{- define "common-volumes" -}}
{{- get ((include "redpanda.CommonVolumes" (dict "a" (list .))) | fromJson) "r" | toYaml }}
{{- end -}}

{{/* the default set of volumes for most pods, except the sts pod */}}
{{- define "default-volumes" -}}
{{- get ((include "redpanda.DefaultVolumes" (dict "a" (list .))) | fromJson) "r" | toYaml }}
{{- end -}}
